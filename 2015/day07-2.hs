...
solution :: String -> Int
-- Remove instruction to wire 'b' and append a new instruction for wire 'b', with the result from part 1
solution = evaluate "a" empty . (("3176", "", SIG, "b") :) . filter ((/= "b") . target) . map parse . lines
