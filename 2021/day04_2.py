...
def play(boards: list[Board], numbers: list[int]):
    ...
    for number in numbers:
        ...
        winning_boards = [board for board in current if is_winner(board)]
        winning_board = winning_boards[0] if winning_boards else winning_board
        winning_number = number if winning_boards else winning_number
        current = [board for board in current if not is_winner(board)]
